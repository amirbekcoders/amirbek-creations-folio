...
const footerContent = {
  en: {
    copyright: `© ${new Date().getFullYear()} Nodirbekov Amirbek. All rights reserved.`,
    builtWith: "Built with React, TypeScript & Tailwind CSS"
  },
  ru: {
    copyright: `© ${new Date().getFullYear()} Нодирбеков Амирбек. Все права защищены.`,
    builtWith: "Создано с React, TypeScript и Tailwind CSS"
  },
  uz: {
    copyright: `© ${new Date().getFullYear()} Nodirbekov Amirbek. Barcha huquqlar himoyalangan.`,
