...
const footerContent = {
  en: {
    copyright: "Nodirbekov Amirbek. All rights reserved.",
    builtWith: "Built with React, TypeScript & Tailwind CSS"
  },
  ru: {
    copyright: "Нодирбеков Амирбек. Все права защищены.",
    builtWith: "Создано с React, TypeScript и Tailwind CSS"
  },
  uz: {
    copyright: "Nodirbekov Amirbek. Barcha huquqlar himoyalangan.",
